...
import img from '../views/assets/ttlogin.jfif';
...
function Registerpage() {
  ...
  const handleSubmit = async e => {
    e.preventDefault();
    registerUser(email, username, password, password2, role);
  }
                ...
                <div className="row g-0">
                  <div className="col-md-6 col-lg-5 d-none d-md-block">
                    <img
                      ...
                      alt="login form"
                      className="img-fluid"
                      style={{ borderRadius: "1rem 0 0 1rem", width: "1000px", height: "300px", marginTop: "100px" }}
                    />
                  </div>
                    ...
                    <div className="card-body p-4 p-lg-5 text-black">
                      <form onSubmit={handleSubmit}>
                        <div className="d-flex align-items-center mb-3 pb-1">
                          ...
                          <span className="h2 fw-bold mb-0">Espace Staff</span>
                        </div>
